...
$addresses_grid = NULL; // Initialize page object first

class caddresses_grid extends caddresses {
	...
	// Page object name
	var $PageObjName = 'addresses_grid';

	// Grid form hidden field names
	var $FormName = 'faddressesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["addresses"];
