...
class caddresses_list extends caddresses {
	...
	function GetFilterList() {
		...
		$sFilterList = "";
		$sSavedFilterList = "";
		$sFilterList = ew_Concat($sFilterList, $this->AddressID->AdvancedSearch->ToJson(), ","); // Field AddressID
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->POBox); // POBox
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ewMultiSelect\" value=\"" . ew_HtmlEncode($this->AddressID->CurrentValue) . "\" onclick=\"ew_ClickMultiCheckbox(event);\">";
...
faddresseslist.Lists["x_CustomerID"] = {"LinkField":"x_CustomerID","Ajax":true,"AutoFill":false,"DisplayFields":["x_FullName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"customers"};
faddresseslist.Lists["x_CustomerID"].Data = "<?php echo $addresses_list->CustomerID->LookupFilterQuery(FALSE, "list") ?>";
faddresseslist.Lists["x_ProvinceID"] = {"LinkField":"x_ProvinceID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provinces"};
faddresseslist.Lists["x_ProvinceID"].Data = "<?php echo $addresses_list->ProvinceID->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($addresses->CustomerID->Visible) { // CustomerID ?>
	...
	<?php } else { ?>
		<th data-name="CustomerID" class="<?php echo $addresses->CustomerID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $addresses->SortUrl($addresses->CustomerID) ?>',1);"><div id="elh_addresses_CustomerID" class="addresses_CustomerID">
...
<?php if ($addresses->ProvinceID->Visible) { // ProvinceID ?>
	...
	<?php } else { ?>
		<th data-name="ProvinceID" class="<?php echo $addresses->ProvinceID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $addresses->SortUrl($addresses->ProvinceID) ?>',1);"><div id="elh_addresses_ProvinceID" class="addresses_ProvinceID">
...
<?php if ($addresses->POBox->Visible) { // POBox ?>
	...
	<?php } else { ?>
		<th data-name="POBox" class="<?php echo $addresses->POBox->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $addresses->SortUrl($addresses->POBox) ?>',1);"><div id="elh_addresses_POBox" class="addresses_POBox">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $addresses->POBox->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($addresses->POBox->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($addresses->POBox->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $addresses_list->RowCnt ?>_addresses_CustomerID" class="addresses_CustomerID">
...
<span id="el<?php echo $addresses_list->RowCnt ?>_addresses_ProvinceID" class="addresses_ProvinceID">
...
<span id="el<?php echo $addresses_list->RowCnt ?>_addresses_POBox" class="addresses_POBox">
