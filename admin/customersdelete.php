...
fcustomersdelete.Lists["x_ActivityStatus"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcustomersdelete.Lists["x_ActivityStatus"].Options = <?php echo json_encode($customers_delete->ActivityStatus->Options()) ?>;
...
<?php if ($customers->FullName->Visible) { // FullName ?>
		<th class="<?php echo $customers->FullName->HeaderCellClass() ?>"><span id="elh_customers_FullName" class="customers_FullName"><?php echo $customers->FullName->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($customers->UserName->Visible) { // UserName ?>
		<th class="<?php echo $customers->UserName->HeaderCellClass() ?>"><span id="elh_customers_UserName" class="customers_UserName"><?php echo $customers->UserName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($customers->UserPass->Visible) { // UserPass ?>
		<th class="<?php echo $customers->UserPass->HeaderCellClass() ?>"><span id="elh_customers_UserPass" class="customers_UserPass"><?php echo $customers->UserPass->FldCaption() ?></span></th>
<?php } ?>
<?php if ($customers->ActivityStatus->Visible) { // ActivityStatus ?>
		<th class="<?php echo $customers->ActivityStatus->HeaderCellClass() ?>"><span id="elh_customers_ActivityStatus" class="customers_ActivityStatus"><?php echo $customers->ActivityStatus->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $customers_delete->RowCnt ?>_customers_FullName" class="customers_FullName">
...
<span id="el<?php echo $customers_delete->RowCnt ?>_customers_UserName" class="customers_UserName">
...
<span id="el<?php echo $customers_delete->RowCnt ?>_customers_UserPass" class="customers_UserPass">
...
<span id="el<?php echo $customers_delete->RowCnt ?>_customers_ActivityStatus" class="customers_ActivityStatus">
