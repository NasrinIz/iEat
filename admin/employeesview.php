...
femployeesview.Lists["x_ProvinceID"] = {"LinkField":"x_ProvinceID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provinces"};
femployeesview.Lists["x_ProvinceID"].Data = "<?php echo $employees_view->ProvinceID->LookupFilterQuery(FALSE, "view") ?>";
femployeesview.Lists["x_Level"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
femployeesview.Lists["x_Level"].Data = "<?php echo $employees_view->Level->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($employees->EmployeeID->Visible) { // EmployeeID ?>
	<tr id="r_EmployeeID">
		<td class="col-sm-2"><span id="elh_employees_EmployeeID"><?php echo $employees->EmployeeID->FldCaption() ?></span></td>
...
<?php echo $employees->EmployeeID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $employees->FullName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($employees->UserName->Visible) { // UserName ?>
	<tr id="r_UserName">
		<td class="col-sm-2"><span id="elh_employees_UserName"><?php echo $employees->UserName->FldCaption() ?></span></td>
...
<?php echo $employees->UserName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($employees->UserPass->Visible) { // UserPass ?>
	<tr id="r_UserPass">
		<td class="col-sm-2"><span id="elh_employees_UserPass"><?php echo $employees->UserPass->FldCaption() ?></span></td>
...
<?php echo $employees->UserPass->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($employees->ProvinceID->Visible) { // ProvinceID ?>
	<tr id="r_ProvinceID">
		<td class="col-sm-2"><span id="elh_employees_ProvinceID"><?php echo $employees->ProvinceID->FldCaption() ?></span></td>
...
<?php echo $employees->ProvinceID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($employees->ZipCode->Visible) { // ZipCode ?>
	<tr id="r_ZipCode">
		<td class="col-sm-2"><span id="elh_employees_ZipCode"><?php echo $employees->ZipCode->FldCaption() ?></span></td>
...
<?php echo $employees->ZipCode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($employees->Level->Visible) { // Level ?>
	<tr id="r_Level">
		<td class="col-sm-2"><span id="elh_employees_Level"><?php echo $employees->Level->FldCaption() ?></span></td>
...
<?php echo $employees->Level->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
