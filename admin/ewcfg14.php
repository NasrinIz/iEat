...
define("EW_PROJECT_NAME", "project6011", TRUE); // Project name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "mehranis_root", "pass" => "v4X?lv-OzNw6", "db" => "mehranis_ieat", "qs" => "`", "qe" => "`");
...
// Security
define("EW_ADMIN_USER_NAME", "superadmin", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "Ad123456", TRUE); // Administrator password
...
// Horizontal nenu
$EW_USE_SUBMENU_FOR_ROOT_HEADER = TRUE;
$EW_BODY_CLASS .= " layout-top-nav";
?>
<?php
