...
$orderdetails_add = NULL; // Initialize page object first

class corderdetails_add extends corderdetails {
	...
	// Page object name
	var $PageObjName = 'orderdetails_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["OrderDetailID"] != "") {
				$this->OrderDetailID->setQueryStringValue($_GET["OrderDetailID"]);
				$this->setKey("OrderDetailID", $this->OrderDetailID->CurrentValue); // Set up key
			} else {
				$this->setKey("OrderDetailID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "orderdetailsview.php")
	...
	function LoadDefaultValues() {
		...
		$this->OrderDetailID->OldValue = $this->OrderDetailID->CurrentValue;
		...
		$this->SubMenu->CurrentValue = NULL;
		$this->SubMenu->OldValue = $this->SubMenu->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['OrderDetailID'] = $this->OrderDetailID->CurrentValue;
		$row['OrderID'] = $this->OrderID->CurrentValue;
		$row['Quantity'] = $this->Quantity->CurrentValue;
		$row['MenuID'] = $this->MenuID->CurrentValue;
		$row['SubMenu'] = $this->SubMenu->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// OrderID
		$this->OrderID->SetDbValueDef($rsnew, $this->OrderID->CurrentValue, 0, FALSE);
		...
		// SubMenu
		$this->SubMenu->SetDbValueDef($rsnew, $this->SubMenu->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($orderdetails_add)) $orderdetails_add = new corderdetails_add();

// Page init
$orderdetails_add->Page_Init();

// Page main
$orderdetails_add->Page_Main();
...
var CurrentForm = forderdetailsadd = new ew_Form("forderdetailsadd", "add");
...
forderdetailsadd.Form_CustomValidate = 
...
forderdetailsadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
forderdetailsadd.Lists["x_OrderID"] = {"LinkField":"x_OrderID","Ajax":true,"AutoFill":false,"DisplayFields":["x_OrderID","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"orders"};
forderdetailsadd.Lists["x_OrderID"].Data = "<?php echo $orderdetails_add->OrderID->LookupFilterQuery(FALSE, "add") ?>";
forderdetailsadd.Lists["x_MenuID"] = {"LinkField":"x_MenuID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":["x_SubMenu"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"menus"};
forderdetailsadd.Lists["x_MenuID"].Data = "<?php echo $orderdetails_add->MenuID->LookupFilterQuery(FALSE, "add") ?>";
forderdetailsadd.Lists["x_SubMenu"] = {"LinkField":"x_SubMenuID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":["x_MenuID"],"ChildFields":[],"FilterFields":["x_MenuID"],"Options":[],"Template":"","LinkTable":"sub_menus"};
forderdetailsadd.Lists["x_SubMenu"].Data = "<?php echo $orderdetails_add->SubMenu->LookupFilterQuery(FALSE, "add") ?>";
...
?>
<form name="forderdetailsadd" id="forderdetailsadd" class="<?php echo $orderdetails_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($orderdetails_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $orderdetails_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="orderdetails">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($orderdetails_add->IsModal) ?>">
...
<?php if ($orderdetails->OrderID->Visible) { // OrderID ?>
	<div id="r_OrderID" class="form-group">
		<label id="elh_orderdetails_OrderID" for="x_OrderID" class="<?php echo $orderdetails_add->LeftColumnClass ?>"><?php echo $orderdetails->OrderID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($orderdetails->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group">
		<label id="elh_orderdetails_Quantity" for="x_Quantity" class="<?php echo $orderdetails_add->LeftColumnClass ?>"><?php echo $orderdetails->Quantity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($orderdetails->MenuID->Visible) { // MenuID ?>
	<div id="r_MenuID" class="form-group">
		<label id="elh_orderdetails_MenuID" for="x_MenuID" class="<?php echo $orderdetails_add->LeftColumnClass ?>"><?php echo $orderdetails->MenuID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $orderdetails_add->RightColumnClass ?>"><div<?php echo $orderdetails->MenuID->CellAttributes() ?>>
...
<?php if ($orderdetails->SubMenu->Visible) { // SubMenu ?>
	<div id="r_SubMenu" class="form-group">
		<label id="elh_orderdetails_SubMenu" for="x_SubMenu" class="<?php echo $orderdetails_add->LeftColumnClass ?>"><?php echo $orderdetails->SubMenu->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $orderdetails_add->RightColumnClass ?>"><div<?php echo $orderdetails->SubMenu->CellAttributes() ?>>
...
<?php if ($orderdetails->Price->Visible) { // Price ?>
	<div id="r_Price" class="form-group">
		<label id="elh_orderdetails_Price" for="x_Price" class="<?php echo $orderdetails_add->LeftColumnClass ?>"><?php echo $orderdetails->Price->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $orderdetails_add->RightColumnClass ?>"><div<?php echo $orderdetails->Price->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $orderdetails_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
forderdetailsadd.Init();
</script>
<?php
...
<?php
$orderdetails_add->Page_Terminate();
?>
