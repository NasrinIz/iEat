...
$orderdetails_delete = NULL; // Initialize page object first

class corderdetails_delete extends corderdetails {
	...
	// Page object name
	var $PageObjName = 'orderdetails_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("orderdetailslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in orderdetails class, orderdetailsinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("orderdetailslist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($orderdetails_delete)) $orderdetails_delete = new corderdetails_delete();

// Page init
$orderdetails_delete->Page_Init();

// Page main
$orderdetails_delete->Page_Main();
...
var CurrentForm = forderdetailsdelete = new ew_Form("forderdetailsdelete", "delete");

// Form_CustomValidate event
forderdetailsdelete.Form_CustomValidate = 
...
forderdetailsdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
forderdetailsdelete.Lists["x_MenuID"] = {"LinkField":"x_MenuID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":["x_SubMenu"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"menus"};
forderdetailsdelete.Lists["x_MenuID"].Data = "<?php echo $orderdetails_delete->MenuID->LookupFilterQuery(FALSE, "delete") ?>";
forderdetailsdelete.Lists["x_SubMenu"] = {"LinkField":"x_SubMenuID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sub_menus"};
forderdetailsdelete.Lists["x_SubMenu"].Data = "<?php echo $orderdetails_delete->SubMenu->LookupFilterQuery(FALSE, "delete") ?>";
...
?>
<form name="forderdetailsdelete" id="forderdetailsdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($orderdetails_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $orderdetails_delete->Token ?>">
<?php } ?>
...
<?php if ($orderdetails->Quantity->Visible) { // Quantity ?>
		<th class="<?php echo $orderdetails->Quantity->HeaderCellClass() ?>"><span id="elh_orderdetails_Quantity" class="orderdetails_Quantity"><?php echo $orderdetails->Quantity->FldCaption() ?></span></th>
<?php } ?>
<?php if ($orderdetails->MenuID->Visible) { // MenuID ?>
		<th class="<?php echo $orderdetails->MenuID->HeaderCellClass() ?>"><span id="elh_orderdetails_MenuID" class="orderdetails_MenuID"><?php echo $orderdetails->MenuID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($orderdetails->SubMenu->Visible) { // SubMenu ?>
		<th class="<?php echo $orderdetails->SubMenu->HeaderCellClass() ?>"><span id="elh_orderdetails_SubMenu" class="orderdetails_SubMenu"><?php echo $orderdetails->SubMenu->FldCaption() ?></span></th>
<?php } ?>
<?php if ($orderdetails->Price->Visible) { // Price ?>
		<th class="<?php echo $orderdetails->Price->HeaderCellClass() ?>"><span id="elh_orderdetails_Price" class="orderdetails_Price"><?php echo $orderdetails->Price->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($orderdetails->MenuID->Visible) { // MenuID ?>
		<td<?php echo $orderdetails->MenuID->CellAttributes() ?>>
<span id="el<?php echo $orderdetails_delete->RowCnt ?>_orderdetails_MenuID" class="orderdetails_MenuID">
...
<?php } ?>
<?php if ($orderdetails->SubMenu->Visible) { // SubMenu ?>
		<td<?php echo $orderdetails->SubMenu->CellAttributes() ?>>
<span id="el<?php echo $orderdetails_delete->RowCnt ?>_orderdetails_SubMenu" class="orderdetails_SubMenu">
...
<?php } ?>
<?php if ($orderdetails->Price->Visible) { // Price ?>
		<td<?php echo $orderdetails->Price->CellAttributes() ?>>
<span id="el<?php echo $orderdetails_delete->RowCnt ?>_orderdetails_Price" class="orderdetails_Price">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $orderdetails_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
forderdetailsdelete.Init();
</script>
<?php
...
<?php
$orderdetails_delete->Page_Terminate();
?>
