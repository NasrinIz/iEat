...
$orderdetails_view = NULL; // Initialize page object first

class corderdetails_view extends corderdetails {
	...
	// Page object name
	var $PageObjName = 'orderdetails_view';
	...
	function __construct() {
		...
		if (@$_GET["OrderDetailID"] <> "") {
			$this->RecKey["OrderDetailID"] = $_GET["OrderDetailID"];
			$KeyUrl .= "&amp;OrderDetailID=" . urlencode($this->RecKey["OrderDetailID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["OrderDetailID"] <> "") {
			...
			$gsExportFile .= $_GET["OrderDetailID"];
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["OrderDetailID"] <> "") {
				...
				$this->RecKey["OrderDetailID"] = $this->OrderDetailID->QueryStringValue;
			} elseif (@$_POST["OrderDetailID"] <> "") {
				$this->OrderDetailID->setFormValue($_POST["OrderDetailID"]);
				$this->RecKey["OrderDetailID"] = $this->OrderDetailID->FormValue;
			} else {
				$sReturnUrl = "orderdetailslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "orderdetailslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "orderdetailslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_orderdetails\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_orderdetails',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.forderdetailsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($orderdetails_view)) $orderdetails_view = new corderdetails_view();

// Page init
$orderdetails_view->Page_Init();

// Page main
$orderdetails_view->Page_Main();
...
var CurrentForm = forderdetailsview = new ew_Form("forderdetailsview", "view");

// Form_CustomValidate event
forderdetailsview.Form_CustomValidate = 
...
forderdetailsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
forderdetailsview.Lists["x_OrderID"] = {"LinkField":"x_OrderID","Ajax":true,"AutoFill":false,"DisplayFields":["x_OrderID","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"orders"};
forderdetailsview.Lists["x_OrderID"].Data = "<?php echo $orderdetails_view->OrderID->LookupFilterQuery(FALSE, "view") ?>";
forderdetailsview.Lists["x_MenuID"] = {"LinkField":"x_MenuID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":["x_SubMenu"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"menus"};
forderdetailsview.Lists["x_MenuID"].Data = "<?php echo $orderdetails_view->MenuID->LookupFilterQuery(FALSE, "view") ?>";
forderdetailsview.Lists["x_SubMenu"] = {"LinkField":"x_SubMenuID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sub_menus"};
forderdetailsview.Lists["x_SubMenu"].Data = "<?php echo $orderdetails_view->SubMenu->LookupFilterQuery(FALSE, "view") ?>";
...
?>
<form name="forderdetailsview" id="forderdetailsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($orderdetails_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $orderdetails_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="orderdetails">
<input type="hidden" name="modal" value="<?php echo intval($orderdetails_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($orderdetails->OrderDetailID->Visible) { // OrderDetailID ?>
	<tr id="r_OrderDetailID">
		<td class="col-sm-2"><span id="elh_orderdetails_OrderDetailID"><?php echo $orderdetails->OrderDetailID->FldCaption() ?></span></td>
		<td data-name="OrderDetailID"<?php echo $orderdetails->OrderDetailID->CellAttributes() ?>>
<span id="el_orderdetails_OrderDetailID">
<span<?php echo $orderdetails->OrderDetailID->ViewAttributes() ?>>
<?php echo $orderdetails->OrderDetailID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orderdetails->OrderID->Visible) { // OrderID ?>
	<tr id="r_OrderID">
		<td class="col-sm-2"><span id="elh_orderdetails_OrderID"><?php echo $orderdetails->OrderID->FldCaption() ?></span></td>
...
<?php echo $orderdetails->OrderID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orderdetails->Quantity->Visible) { // Quantity ?>
	<tr id="r_Quantity">
		<td class="col-sm-2"><span id="elh_orderdetails_Quantity"><?php echo $orderdetails->Quantity->FldCaption() ?></span></td>
...
<?php echo $orderdetails->Quantity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orderdetails->MenuID->Visible) { // MenuID ?>
	<tr id="r_MenuID">
		<td class="col-sm-2"><span id="elh_orderdetails_MenuID"><?php echo $orderdetails->MenuID->FldCaption() ?></span></td>
...
<?php echo $orderdetails->MenuID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orderdetails->SubMenu->Visible) { // SubMenu ?>
	<tr id="r_SubMenu">
		<td class="col-sm-2"><span id="elh_orderdetails_SubMenu"><?php echo $orderdetails->SubMenu->FldCaption() ?></span></td>
...
<?php echo $orderdetails->SubMenu->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($orderdetails->Price->Visible) { // Price ?>
	<tr id="r_Price">
		<td class="col-sm-2"><span id="elh_orderdetails_Price"><?php echo $orderdetails->Price->FldCaption() ?></span></td>
...
<?php
$orderdetails_view->Page_Terminate();
?>
