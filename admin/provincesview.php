...
$provinces_view = NULL; // Initialize page object first

class cprovinces_view extends cprovinces {
	...
	// Page object name
	var $PageObjName = 'provinces_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "provinceslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "provinceslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_provinces\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_provinces',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fprovincesview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($provinces_view)) $provinces_view = new cprovinces_view();

// Page init
$provinces_view->Page_Init();

// Page main
$provinces_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$provinces_view->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($provinces->Export == "") { ?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "view";
var CurrentForm = fprovincesview = new ew_Form("fprovincesview", "view");

// Form_CustomValidate event
fprovincesview.Form_CustomValidate = 
...
fprovincesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($provinces->Export == "") { ?>
<div class="ewToolbar">
<?php $provinces_view->ExportOptions->Render("body") ?>
<?php
	foreach ($provinces_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $provinces_view->ShowPageHeader(); ?>
<?php
$provinces_view->ShowMessage();
?>
<form name="fprovincesview" id="fprovincesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($provinces_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $provinces_view->Token ?>">
<?php } ?>
