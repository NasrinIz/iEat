...
fstoresadd.Lists["x_ProvinceID"] = {"LinkField":"x_ProvinceID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provinces"};
fstoresadd.Lists["x_ProvinceID"].Data = "<?php echo $stores_add->ProvinceID->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($stores->ProvinceID->Visible) { // ProvinceID ?>
	<div id="r_ProvinceID" class="form-group">
		<label id="elh_stores_ProvinceID" for="x_ProvinceID" class="<?php echo $stores_add->LeftColumnClass ?>"><?php echo $stores->ProvinceID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $stores_add->RightColumnClass ?>"><div<?php echo $stores->ProvinceID->CellAttributes() ?>>
...
<?php if ($stores->ZipCode->Visible) { // ZipCode ?>
	<div id="r_ZipCode" class="form-group">
		<label id="elh_stores_ZipCode" for="x_ZipCode" class="<?php echo $stores_add->LeftColumnClass ?>"><?php echo $stores->ZipCode->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $stores_add->RightColumnClass ?>"><div<?php echo $stores->ZipCode->CellAttributes() ?>>
