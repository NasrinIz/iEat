...
class cstores extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'stores';
		$this->TableName = 'stores';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`stores`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`stores`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "storesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "storesadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("storesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("storesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "storesadd.php?" . $this->UrlParm($parm);
		else
			$url = "storesadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("storesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("storesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
