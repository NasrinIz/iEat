...
class cstores_list extends cstores {
	...
	function GetFilterList() {
		...
		$sFilterList = "";
		$sSavedFilterList = "";
		$sFilterList = ew_Concat($sFilterList, $this->StoreID->AdvancedSearch->ToJson(), ","); // Field StoreID
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ewMultiSelect\" value=\"" . ew_HtmlEncode($this->StoreID->CurrentValue) . "\" onclick=\"ew_ClickMultiCheckbox(event);\">";
...
fstoreslist.Lists["x_ProvinceID"] = {"LinkField":"x_ProvinceID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provinces"};
fstoreslist.Lists["x_ProvinceID"].Data = "<?php echo $stores_list->ProvinceID->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($stores->ProvinceID->Visible) { // ProvinceID ?>
	<?php if ($stores->SortUrl($stores->ProvinceID) == "") { ?>
		<th data-name="ProvinceID" class="<?php echo $stores->ProvinceID->HeaderCellClass() ?>"><div id="elh_stores_ProvinceID" class="stores_ProvinceID"><div class="ewTableHeaderCaption"><?php echo $stores->ProvinceID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="ProvinceID" class="<?php echo $stores->ProvinceID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $stores->SortUrl($stores->ProvinceID) ?>',1);"><div id="elh_stores_ProvinceID" class="stores_ProvinceID">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $stores->ProvinceID->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($stores->ProvinceID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($stores->ProvinceID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($stores->ZipCode->Visible) { // ZipCode ?>
	<?php if ($stores->SortUrl($stores->ZipCode) == "") { ?>
		<th data-name="ZipCode" class="<?php echo $stores->ZipCode->HeaderCellClass() ?>"><div id="elh_stores_ZipCode" class="stores_ZipCode"><div class="ewTableHeaderCaption"><?php echo $stores->ZipCode->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="ZipCode" class="<?php echo $stores->ZipCode->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $stores->SortUrl($stores->ZipCode) ?>',1);"><div id="elh_stores_ZipCode" class="stores_ZipCode">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $stores->ZipCode->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($stores->ZipCode->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($stores->ZipCode->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $stores_list->RowCnt ?>_stores_ProvinceID" class="stores_ProvinceID">
...
<span id="el<?php echo $stores_list->RowCnt ?>_stores_ZipCode" class="stores_ZipCode">
