...
class csub_menus_edit extends csub_menus {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_SubMenuID")) {
				$this->SubMenuID->setFormValue($objForm->GetValue("x_SubMenuID"));
			}
		} else {
	...
	function LoadFormValues() {
		...
		if (!$this->SubMenuID->FldIsDetailKey)
			$this->SubMenuID->setFormValue($objForm->GetValue("x_SubMenuID"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->SubMenuID->CurrentValue = $this->SubMenuID->FormValue;
...
fsub_menusedit.Lists["x_MenuID"] = {"LinkField":"x_MenuID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"menus"};
fsub_menusedit.Lists["x_MenuID"].Data = "<?php echo $sub_menus_edit->MenuID->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php if ($sub_menus->SubMenuID->Visible) { // SubMenuID ?>
	<div id="r_SubMenuID" class="form-group">
		<label id="elh_sub_menus_SubMenuID" class="<?php echo $sub_menus_edit->LeftColumnClass ?>"><?php echo $sub_menus->SubMenuID->FldCaption() ?></label>
		<div class="<?php echo $sub_menus_edit->RightColumnClass ?>"><div<?php echo $sub_menus->SubMenuID->CellAttributes() ?>>
<span id="el_sub_menus_SubMenuID">
<span<?php echo $sub_menus->SubMenuID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $sub_menus->SubMenuID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="sub_menus" data-field="x_SubMenuID" name="x_SubMenuID" id="x_SubMenuID" value="<?php echo ew_HtmlEncode($sub_menus->SubMenuID->CurrentValue) ?>">
<?php echo $sub_menus->SubMenuID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($sub_menus->MenuID->Visible) { // MenuID ?>
	<div id="r_MenuID" class="form-group">
		<label id="elh_sub_menus_MenuID" for="x_MenuID" class="<?php echo $sub_menus_edit->LeftColumnClass ?>"><?php echo $sub_menus->MenuID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $sub_menus_edit->RightColumnClass ?>"><div<?php echo $sub_menus->MenuID->CellAttributes() ?>>
